...
load('gmv_all_r.mat') 
load('gmv_id.mat') %%%% gmv samples id
load('methy_index.mat')  %%%%% methylation samples id
load('sig_methy_cpg_2.mat')
load('pathway_gene_targetpath.mat')
load('demethy_pls_genes05.mat')  %%% PLS and DMP overlapped genes 
load('cpg_site.mat') %%% PLS and DMP overlapped genes' cpg sites


%% methy and gmv corr 获取甲基化样本对应 gmv 计算相关
...
%% pca 甲基化PCA降维；进行glm 线性拟合 pls_overlap  mdd
